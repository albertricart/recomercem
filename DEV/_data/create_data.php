...
// $databaseAry[] = 'SET SQL_MODE = "NO_AUTO_VALUE_ON_ZERO";'; 'START TRANSACTION;'; 'SET time_zone = "+00:00";';
...
// $databaseAry[] = 'ALTER TABLE `comerc` ADD PRIMARY KEY (`id`);';

// $databaseAry[] = 'ALTER TABLE `juego` ADD PRIMARY KEY (`id`);';

// $databaseAry[] = 'ALTER TABLE `oferta` ADD PRIMARY KEY (`id`);';
...
// $databaseAry[] = 'ALTER TABLE `ticket` ADD PRIMARY KEY (`id`),
$databaseAry[] = 'ALTER TABLE `ticket`
  ADD KEY `id_comerc` (`id_comerc`),
  ADD KEY `id_usuario` (`id_usuario`);';

// $databaseAry[] = 'ALTER TABLE `usuario` ADD PRIMARY KEY (`id`);';

// $databaseAry[] = 'ALTER TABLE `usuario` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;';
