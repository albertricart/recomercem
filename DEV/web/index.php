...
<article id="mainOffers" class="artlBox" style="background-color: #6395ee;">

    <h1 class="artlTitle" style="background-image: url(/images/icon_offers_white.svg);">Last Offers</h1>

</article>

<article id="mainStores" class="artlBox" style="background-color: #63ee91;">
...
<article id="mainGames" class="artlBox" style="background-color: #e0ee63;">
