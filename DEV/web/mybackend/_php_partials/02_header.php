...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <a class="navbar-brand" href="index.php">
    <img src="/images/recomercem_icon_white.png" class="rounded float-left mr-3" style="width: 50px; height: 50px;" />
    <h1 class="navbar-text text-white h3">reComercem Panel de Administracion</h1>
  </a>
