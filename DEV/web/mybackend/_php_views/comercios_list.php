...
// - - - - - DB Data conection
include("../php_librarys/_db.php"); 
// - - - - - Pokemon functions
include("../php_librarys/functions_generic.php"); 
// - - - - - General SETs
...
<div class="container-fluid">
    ...
    <div class="row my-2">
        ...
        <div class="col col-2 card bg-white text-white mx-2 px-0  d-flex flex-column">
            ...
            <div class="mt-auto p-2 card-footer d-flex flex-row align-items-end justify-content-end">
                ...
                <!-- XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX -->
                <form action="../php_controllers/comerciosControler.php" method="POST" target="_self">
    ...
    <a href="../php_controllers/comerciosControler.php?idAction=<?php echo SQL_INSERT;?>" target="_self" style="display: block; position: fixed; right: 10px; bottom: 10px; width: auto; height: auto; padding: 10px; background-color: var(--primary); border-radius: 25px; z-index:100;">
