...
// - - - - - - - - - - - - - - - - - - - - VISTA/FORM PART
if ( file_exists( "_php_controllers/juegosControler.php" ) ) { include_once("_php_controllers/juegosControler.php" ); } 
else { echo "Error: not exists _php_controllers/juegosControler.php (".getcwd().")"; }
