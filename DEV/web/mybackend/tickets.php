...
// - - - - - - - - - - - - - - - - - - - - VISTA/FORM PART
if ( file_exists( "_php_controllers/ticketsControler.php" ) ) { include_once("_php_controllers/ticketsControler.php" ); } 
else { echo "Error: not exists _php_controllers/ticketsControler.php (".getcwd().")"; }
