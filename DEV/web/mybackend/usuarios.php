...
// - - - - - - - - - - - - - - - - - - - - VISTA/FORM PART
if ( file_exists( "_php_controllers/usuariosControler.php" ) ) { include_once("_php_controllers/usuariosControler.php" ); } 
else { echo "Error: not exists _php_controllers/usuariosControler.php (".getcwd().")"; }
